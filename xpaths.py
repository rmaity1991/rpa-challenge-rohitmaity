CONFIG={
    "LATimes":{
        ...
        "news_data":r"//p[@class='promo-description']",
        "news_date":r"//p[@class='promo-timestamp']",
        "news_image":r"//a[@class='link promo-placeholder']",
        "news_next_page":r"//div[@class='search-results-module-next-page']",
        "news_results_open_status":r"//span[@class='search-results-module-count-desktop']",
    }
}
